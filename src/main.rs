...
fn main() {
    ...
    vec![
        ...
        Sequence {
            ...
            seq : vec![45, 66, 65, 45, 71, 71, 71, 71, 65, 84, 71, 67, 84, 65, 65, 71, 67, 67, 65, 65, 84, 71, 65, 71, 84, 84, 71, 84, 84, 71, 84, 67, 84, 67, 84, 67, 65, 65, 84, 71, 84, 71],
        }
    ];

    let expected = Alignment(al);
    build_vg_from_seq_alignment(&expected);
}